 ...
 * @author ciao
 */
public class UtenteServlet extends HttpServlet implements ServletConstantInterface{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Utente utente = (Utente) request.getSession(true).getAttribute(UTENTE_KEY);
